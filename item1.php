...
if(isset($_POST["Submit"])){
  ...
  $user = mysqli_query($con, "SELECT * FROM ADDITEM1 WHERE Product_id = '$Product_id'");
  if(mysqli_num_rows($user) > 0){
    ...
    $query = "INSERT INTO ADDITEM1 VALUES('$Gate_pass', '$DR_No', '$Product_id', '$Product_name', '$Price', '$Quantity', '$Date')";
