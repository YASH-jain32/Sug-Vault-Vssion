...
if(isset($_POST["update_btn"])){
  ...
  $Available_Stock = $_POST["Available_Stock"];
   ...
   $user = mysqli_query($con, "SELECT * FROM STOCK WHERE Product_Id = '$Product_Id'");
  if(mysqli_num_rows($user) > 0){
    ...
    $update = "UPDATE  stock SET Product_Id='$Product_Id', Product_Name='$Product_Name', Available_Stock='$Available_Stock' WHERE Product_Id='$Product_Id'";
